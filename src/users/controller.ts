...
const QBX_TOKEN_DESC = 'With qiibee, businesses around the world can run their loyalty programs on the blockchain. Exchange loyalty tokens to QBX and enter the crypto world'
